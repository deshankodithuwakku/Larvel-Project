...
<form class="mt-5" action="{{route('student.update',$student->id)}}" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="contact_no" value="{{$student->contact_no}}" placeholder="Enter contact number">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="dob" value="{{$student->dob}}" placeholder="Enter Birthday">
  </div>
